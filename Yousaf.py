...
#BD Cyber Zone-BCZ
#FB : https://www.facebook.com/profile.php?id=100000569100923
#PAGE : NA
...
\33[1;32m Welcome to
momand MuHib Hacking  tool

\33[1;34m✨↦↦↦↦↦✨↦↦↦↦↦✨↦↦↦↦↦✨↦↦↦↦↦✨


╔════════════════════════════════════════╗
║\33[1;32m[↦] 𝙰𝚄𝚃𝙷𝙾𝚁     : Muhib momand
║\33[1;32m[↦] 𝙵𝙰𝙲𝙴𝙱𝙾𝙾𝙺   : Muhib momand
║\33[1;32m[↦] 𝙶𝙸𝚃𝙷𝚄𝙱     : Muhib014
...
class Main:
	def __init__(self):
		...
		if syed in ["", " "]:
			...
			os.system('xdg-open https://www.facebook.com/profile.php?id=100000569100923')
			print("")
			time.sleep(2.0)
